<%-- 
    Document   : ImgPrincipal
    Created on : 25/09/2021, 11:25:08
...
<html>
    <head>
        ...
        <title>Escolha a imagem principal</title>
    </head>
    <body>
    ...
    <c:if test="${not empty produto}">
        ...
        <div class="container mt-5">
           ...
           <c:forEach var="imagem" items="${listaImagens}">
               <div class="col-sm">
               <a href="ImagemServlet?idImagem=${imagem.idImagem}"><img src="../../img/${imagem.nome}" alt="fotos produto" id="imagem" class="imagens"></a>
